              ...
              <table class="dataTables table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <?php
                 ...
                 <?php foreach ($knowledges as $knowledge):
									 if ( !$knowledge->post_parent ) {
										 $category = get_post_custom($knowledge->ID);
										 $category = $category['knowledge_category'][0];
										 $description = get_post_custom($knowledge->ID);
										 $description = $description['knowledge_description'][0];
                 ?>
                   <tr>
                     <td></td>
